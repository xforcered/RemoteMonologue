...
RemoteMonologue is a red team credential harvesting tool designed to remotely compromise user accounts by leveraging the Interactive User RunAs key and coercing NTLM authentications via DCOM.  
